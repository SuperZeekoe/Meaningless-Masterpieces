...
class GridGalleryFragment : Fragment() {
    override fun onCreateView(
        ...
        val myGridGalleryItems = listOf(
            ...
            HomeFragment.GalleryItem(R.drawable.art_1, "Grid Title 4"),
            HomeFragment.GalleryItem(R.drawable.art_2, "Grid Title 5"),
            HomeFragment.GalleryItem(R.drawable.art_3, "Grid Title 6"),
